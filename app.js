...
const controller = (function (budgetCtrl, UICtrl) {
    ...
    const updateBudget = function () {
        // 5.a) Calculate the budget
        budgetCtrl.calculateBudget();
        // 5.b) Return the budget
    ...
    const updatePercentages = function () {
        ...
        // 2. Read percentages from the 'BUDGET CONTROLLER' modules
    ...
    const ctrlAddItem = function () {
        ...
        if (input.description !== '' && !isNaN(input.value) && input.value > 0) {
            ...
            // 4. Clear the fields
            UICtrl.clearFields();
            // 5. Calculate and update budget (we call the function
            // we created with our tasks 5 and 6)
            updateBudget();
